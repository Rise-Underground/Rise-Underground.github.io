...
from movement_tracker import update_movement_log
    ...
    if target_slot > state.get("last_scrape_slot_index", -1):
        ...
        if run("python fast_scraper.py"):
            ...
            try:
                ...
                # never let a movement-log problem undo a successful scrape
                print(f"!! movement_tracker failed (non-fatal): {e}")
                log_run("movement_tracker_failed", str(e))
        else:
